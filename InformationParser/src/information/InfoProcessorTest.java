...
public class InfoProcessorTest {
	...
	void testGetNextStringStartsWith() {
		...
		String actual2 = infoProcessor2.getNextStringStartsWith("CIT590");
		assertEquals("CourseID:", actual2);
		actual2 = infoProcessor2.getNextStringStartsWith("StudentID:");
		assertEquals("101", actual2);
		
		actual2 = infoProcessor2.getNextStringStartsWith("goodbye");
