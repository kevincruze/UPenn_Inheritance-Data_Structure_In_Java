...
public class InfoProcessor {
	...
	public String getCourseName() {
		...
		String cName = getNextStringStartsWith("Course:");
		return cName;
	}
	...
	public int getCourseId() {
		...
		String strID = this.getNextStringStartsWith("CourseID:");
	...
	public int getStudentId() {
		...
		String strID = this.getNextStringStartsWith("StudentID:");
		int intID = Integer.parseInt(strID);
	...
	String getNextStringStartsWith(String str) {
		...
		for(int i =0; i < this.lines.size(); i++) {
			if(this.lines.get(i).equals(str)) {
				String nextString = this.lines.get(i+1);
				return nextString;
			}
		}
