...
class VehicleTest {
	...
	void testRefuel() {
		...
		jeep2.refuel(50);
		assertEquals(50, jeep2.getGasRemained());
		jeep2.refuel(75);
		assertEquals(125, jeep2.getGasRemained());
		jeep2.run(2);
		jeep2.refuel(70);
		assertEquals(175, jeep2.getGasRemained());
	...
	void testRun() {
		...
		assertEquals(100, jeep1.getGasRemained());
		jeep1.run(9);
		assertEquals(10, jeep1.getGasRemained());
		assertEquals(190, jeep1.getTotalGasConsumed());
	}
	...
	void testEquals() {
		...
		assertTrue(bike3.equals(bike2));
		assertFalse(bike1.equals(bike2));
		assertTrue(benz.equals(benz1));
	}
