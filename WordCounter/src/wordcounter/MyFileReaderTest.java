...
public class MyFileReaderTest {
	...
	public void testGetCleanContent() {
		...
		expected2.add("In the first case it was necessary to renounce the consciousness of an");
		expected2.add("unreal immobility in space and to recognize a motion we did not feel;");
		expected2.add("\"that does not exist, and to recognize a dependence of which we are not\"");
		expected2.add("conscious.");
		expected2.add("Most people start at our Web site which has the main PG search facility:");
